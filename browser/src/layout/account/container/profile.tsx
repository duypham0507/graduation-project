    ...
    <div className="flex flex-col w-full h-full px-6">
      ...
      <div className="scrollable-view flex flex-col pb-10 w-full">
        <div className="flex flex-row w-full items-center justify-between pr-2">
          ...
          <button
            onClick={handlerSaveUserInfo}
            className="border flex flex-row px-4 py-2 items-center rounded-sm h-8 border-blue-500 text-blue-500 hover:text-white hover:bg-blue-500"
          >
        ...
        <div className="flex rounded">
          ...
          <label
            htmlFor="file"
            className="rounded-full w-[150px] h-[150px] relative cursor-pointer hover:opacity-50 my-2"
          >
            ...
            <img
              ...
              src={avatar ? avatar : "/assets/images/icons/icon-user.jpg"}
              alt=""
            />
          </label>
        </div>
        <div className="flex flex-row mt-5">
          <div className="flex flex-col h-full w-3/5">
            <div className="flex flex-row items-center w-full mb-5">
              <span className="w-[90px] flex-none text-right mr-5">
                Tên hiển thị:
              </span>
        ...
        <a
          className="text-blue-500 mt-[10px] w-[90px] mb-10"
          onClick={() => setOpenModal(true)}
        >
          Đổi mật khẩu
        </a>
        <div className="flex flex-col w-full mt-2">
          <span className="text-xl text-baseGray-100 font-semibold mb-10">
            Thông tin liên hệ
          </span>
          <div className="flex flex-row items-start">
            ...
            <div className="flex flex-col items-start">
              <span className="w-[90px] text-[16px] mr-5 text-gray-500">
                Email:
              </span>
              <div className="flex flex-row items-center">
                ...
                {!profile?.is_verified && (
                  <button
                    onClick={() => verifyEmail()}
                    className="text-[16px] text-gray-300 hover:text-blue-500 ml-4"
                  >
                    Xác minh ngay
                  </button>
                )}
          ...
          <div className="flex flex-row items-start mt-6">
            ...
            <div className="flex flex-col items-start">
              <span className="w-[90px] text-[16px] text-gray-500">
                Địa chỉ:
              </span>
              <div className="flex flex-row items-center space-x-2 text-left">
                {
